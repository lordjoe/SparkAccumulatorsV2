 ...
 * @date 5/28/2015
 */
public class MemoryUseAccumulatorAndBinSize extends IAccumulator<MemoryUseAccumulatorAndBinSize> {
    ...
    private final List<MemoryAndBinSize> usage = new ArrayList<MemoryAndBinSize>();
     ...
     * Use static method empty
     */
    private MemoryUseAccumulatorAndBinSize(MemoryUseAccumulatorAndBinSize copy) {
    ...
    @Override
    public IAccumulator<MemoryUseAccumulatorAndBinSize> copy() {
        return new MemoryUseAccumulatorAndBinSize(this);
    }
    ...
    @Override
    public MemoryUseAccumulatorAndBinSize value() {
        return new MemoryUseAccumulatorAndBinSize(this);
    }
    ...
    public void add(MemoryUseAccumulatorAndBinSize added) {
