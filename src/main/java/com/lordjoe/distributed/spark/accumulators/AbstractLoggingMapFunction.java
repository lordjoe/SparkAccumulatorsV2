 ...
 * Date: 10/23/2014
 */
public abstract class AbstractLoggingMapFunction<K extends Serializable, V extends Serializable>
        extends AbstractLoggingFunctionBase implements MapFunction<K, V> {
